...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\FashionBoardController' => 'getFashionBoardControllerService.php',
            'App\\Controller\\FashionBundleController' => 'getFashionBundleControllerService.php',
            ...
            'knpu.oauth2.client.facebook_main' => 'getKnpu_Oauth2_Client_FacebookMainService.php',
            'knpu.oauth2.client.google_main' => 'getKnpu_Oauth2_Client_GoogleMainService.php',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/vendor/twig/intl-extra/src/IntlExtension.php';
            ...
            include_once $this->targetDirs[3].'/vendor/craue/twigextensions-bundle/Twig/Extension/ArrayHelperExtension.php';
            include_once $this->targetDirs[3].'/vendor/craue/twigextensions-bundle/Twig/Extension/AbstractLocaleAwareExtension.php';
            include_once $this->targetDirs[3].'/vendor/twig/twig/src/Extension/GlobalsInterface.php';
            include_once $this->targetDirs[3].'/vendor/craue/twigextensions-bundle/Twig/Extension/ChangeLanguageExtension.php';
            include_once $this->targetDirs[3].'/vendor/craue/twigextensions-bundle/Twig/Extension/DecorateEmptyValueExtension.php';
            include_once $this->targetDirs[3].'/vendor/craue/twigextensions-bundle/Twig/Extension/FormatDateTimeExtension.php';
            include_once $this->targetDirs[3].'/vendor/craue/twigextensions-bundle/Twig/Extension/FormatNumberExtension.php';
            include_once $this->targetDirs[3].'/vendor/craue/twigextensions-bundle/Twig/Extension/FormExtension.php';
            include_once $this->targetDirs[3].'/vendor/craue/twigextensions-bundle/Twig/Extension/StringHelperExtension.php';
    ...
    protected function getTwigService()
    {
        ...
        $a->addPath(($this->targetDirs[3].'/vendor/symfony/twig-bundle/Resources/views'), '!Twig');
        $a->addPath(($this->targetDirs[3].'/vendor/craue/twigextensions-bundle/Resources/views'), 'CraueTwigExtensions');
        $a->addPath(($this->targetDirs[3].'/vendor/craue/twigextensions-bundle/Resources/views'), '!CraueTwigExtensions');
    ...
    protected function getForm_RegistryService()
    {
        return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Form\\FashionBundleType' => ['privates', 'App\\Form\\FashionBundleType', 'getFashionBundleTypeService.php', true],
        ...
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'CraueTwigExtensionsBundle' => [
                    'path' => ($this->targetDirs[3].'/vendor/craue/twigextensions-bundle'),
